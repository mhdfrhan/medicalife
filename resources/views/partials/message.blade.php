        ...
        <div class="flex items-center gap-x-4">
            <div class="flex-shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="h-6 w-6 text-blue-100 mt-0.5">
            ...
            <div>
                <div class="text-sm text-white font-medium">
                    {{ session('message') }}
						...
						<div class="w-7 h-7 flex items-center justify-center rounded-full hover:bg-blue-600/40">
							<button type="button" class="inline-flex text-blue-100" data-hs-remove-element="#alert">
									<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
