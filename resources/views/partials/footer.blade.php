			...
			<div class="w-full lg:w-1/2 px-4">
				<div class="max-w-lg xl:max-w-xl mx-auto xl:mr-0">
					<div class="mb-6 pb-6 border-b border-gray-700">
						<div class="-mb-4">
							<a class="inline-flex mb-4 mr-10 items-center text-white hover:text-blue-green font-medium" href="#">
							...
							<a class="inline-flex mb-4 items-center text-white hover:text-blue-green font-medium" href="#">
					...
					<div class="flex -mb-2 flex-wrap items-center">
						<a class="inline-block mb-2 mr-8 xl:mr-12 text-gray-400 hover:text-gray-200 font-medium"
							href="#">Company</a>
						<a class="inline-block mb-2 mr-8 xl:mr-12 text-gray-400 hover:text-gray-200 font-medium"
							href="#">Resource</a>
						<a class="inline-block mb-2 mr-8 xl:mr-12 text-gray-400 hover:text-gray-200 font-medium"
							href="#">Tracking</a>
						<a class="inline-block mb-2 mr-8 xl:mr-12 text-gray-400 hover:text-gray-200 font-medium" href="#">Help</a>
					</div>
				</div>
			</div>
		</div>
