...
<div>
    <div class="flex items-center justify-between">
        <div>
            <h1 class="heading !capitalize !font-extrabold">Tambah Produk</h1>
            <p class="text-gray-500 mt-2">Silahkan tambahkan produk Anda dibawah ini.</p>
        </div>
        <div class="mt-8 flex items-center gap-3">
            <button wire:click='draft'
                class="py-2.5 px-4 text-center border-gray-300 hover:bg-gray-200 hover:border-gray-200 border text-sm text-blue-green rounded-lg font-semibold duration-300">Simpan
                ke Draft</button>
